...
scheduler = BackgroundScheduler() # A background scheduler to run the check_websites function periodically
    ...
    for email, url in subscriptions:
        try:
            ...
            if response.status_code != 200: 
                ...
                server.sendmail(SENDER_EMAIL_ADDRESS, email, f'The website {url} is down.') 
                server.quit() 
